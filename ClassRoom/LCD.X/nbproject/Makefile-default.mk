...
SOURCEFILES_QUOTED_IF_SPACED=LCD_Class.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/LCD_Class.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/LCD_Class.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/LCD_Class.p1

# Source Files
SOURCEFILES=LCD_Class.c
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/LCD_Class.p1: LCD_Class.c  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/LCD_Class.p1.d 
	@${RM} ${OBJECTDIR}/LCD_Class.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -mdebugger=none   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx32 -Wl,--data-init -mno-keep-startup -mno-osccal -mno-resetbits -mno-save-resetbits -mno-download -mno-stackcall -mno-default-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto     -o ${OBJECTDIR}/LCD_Class.p1 LCD_Class.c 
	@-${MV} ${OBJECTDIR}/LCD_Class.d ${OBJECTDIR}/LCD_Class.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/LCD_Class.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
