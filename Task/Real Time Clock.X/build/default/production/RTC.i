...
void i2c_init(unsigned long baud) {
    ...
    *SSP_STAT = 0x00;
    *SSPCON_2 = 0x00;
    *SSP_ADD = (20000000/(4*baud))-1;
}
void i2c_wait() {
    while((*SSP_STAT)&0X04 || (*SSPCON_2&0X1F));
}
void i2c_start() {
    i2c_wait();
    (*SSPCON_2)|=0x01;
...
unsigned char i2c_read() {
    ...
    val = *SSP_BUF;
    i2c_wait();
    (*SSPCON_2)|=(((*SSPCON_2)&0x40)?0:1)&0x20;
    (*SSPCON_2)|=0x10;
    return val;
}
...
void update() {
    ...
    i2c_start();
    i2c_write(0xD1);
    sec = bcd2dec(i2c_read());
    min = bcd2dec(i2c_read());
    hour = bcd2dec(i2c_read());
