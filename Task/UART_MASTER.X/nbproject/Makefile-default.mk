...
FINAL_IMAGE=${DISTDIR}/UART_MASTER.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/UART_MASTER.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
