...
# 2 "<built-in>" 2
# 1 "RTC_EEPROM_main.c" 2
# 1 "./RTC_EEPROM_header.h" 1
...
void main(void) {
    unsigned int Add1 = 0x0020, Add2 = 0x0028, Add3 = 0x0037;
    unsigned char Data1 = 0x05, Data2 = '2', Data3 = 'c';
    i2c_init(10000);
    init();
    setup();
    EEPROM_Write(Add1, Data1);
    _delay((unsigned long)((100)*(16000000/4000.0)));
    EEPROM_Write(Add2, Data2);
    _delay((unsigned long)((100)*(16000000/4000.0)));
    EEPROM_Write(Add3, Data3);
    _delay((unsigned long)((100)*(16000000/4000.0)));
    EEPROM_Read(Add1);
    EEPROM_Read(Add2);
    EEPROM_Read(Add3);
